...
// var sectorMap2009 = ee.Image(sectorShell2009)
// .where(nirDiff2009to2011.gt(0).and(nirDiff2009to2011.gt(0)), 1)
// .where(nirDiff2009to2011.gt(0).and(nirDiff2009to2011.lt(0)), 2)
// .where(nirDiff2009to2011.lt(0).and(nirDiff2009to2011.gt(0)), 3)
// .where(nirDiff2009to2011.lt(0).and(nirDiff2009to2011.lt(0)), 4)
// .updateMask(sectorShell2009);
...
var sectorMap2013 = ee.Image(sectorShell2013)
.where(nirDiff2011to2013.gt(0).and(nirDiff2011to2013.gt(0)), 1)
.where(nirDiff2011to2013.gt(0).and(nirDiff2011to2013.lt(0)), 2)
.where(nirDiff2011to2013.lt(0).and(nirDiff2011to2013.gt(0)), 3)
.where(nirDiff2011to2013.lt(0).and(nirDiff2011to2013.lt(0)), 4)
.updateMask(sectorShell2013);
...
var sectorMap2015 = ee.Image(sectorShell2015)
.where(nirDiff2013to2015.gt(0).and(nirDiff2013to2015.gt(0)), 1)
.where(nirDiff2013to2015.gt(0).and(nirDiff2013to2015.lt(0)), 2)
.where(nirDiff2013to2015.lt(0).and(nirDiff2013to2015.gt(0)), 3)
.where(nirDiff2013to2015.lt(0).and(nirDiff2013to2015.lt(0)), 4)
.updateMask(sectorShell2015);
...
// // CM = [Date2Band1 - Date1Band1]2 + [Date2Band2 - Date1Band2]2 

var cm2011 = (date2band1.subtract(date1band1).pow(2)).add((date2band2.subtract(date1band2).pow(2)));
var cm2013 = (date3band1.subtract(date2band1).pow(2)).add((date3band2.subtract(date2band2).pow(2)));
var cm2015 = (date4band1.subtract(date3band1).pow(2)).add((date4band2.subtract(date3band2).pow(2)));

Map.addLayer(cm2011, {palette: ['#ff033d', '#000000']}, '2011 Change Magnitude');
Map.addLayer(cm2013, {palette: ['#ff033d', '#000000']}, '2013 Change Magnitude');
Map.addLayer(cm2015, {palette: ['#ff033d', '#000000']}, '2015 Change Magnitude');
